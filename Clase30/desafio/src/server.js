...
if (isCluster && cluster.isPrimary) {
    ...
    const serverExpress = app.listen(PORT, (err)=> err ? console.log(`Error en el server: ${err}`) : console.log(`Server listening on: http://${config.HOST}:${config.PORT} || PID: ${process.pid}`));
