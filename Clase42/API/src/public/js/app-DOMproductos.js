    ...
    arrayProductos.forEach((producto) => {
        ...
        contenedor.innerHTML = `<!-- PRODUCT ${producto._id}-->
                        ...
                        <div class="mb-3 position-relative">
                            <div class="badge text-black badge-primary">${(producto.stock > 0) ? "DISPONIBLE" : "AGOTADO"}</div><a id="detalle-${producto._id}" class="d-block" href="/tienda/detalle"><img class="img-fluid w-100" src="${producto.foto}" alt="${producto.nombre}"></a>
